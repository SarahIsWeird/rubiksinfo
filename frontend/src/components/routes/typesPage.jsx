    ...
    <>
        ...
        <div className="full">
            <table>
                ...
                <tr>
                    <td>
                        <div className="flex centering text-left">
                ...
                <tr>
                    <td>
                        <img className="type-img" src="images/normalRubic.jpg" alt="3x3x3"/>
                        <br/>
                    ...
                    <td>
                        <img className="type-img" src="images/rubicsEdge.jpg" alt="3x3x1"/>
                        <br/>
                    ...
                    <td>
                        <img className="type-img" src="images/pear.jpg" alt="Birne"/>
                        <br/>
                    ...
                    <td>
                        <img className="type-img" src="images/pyramid.jpg" alt="Pyramide"/>
                        <br/>
                ...
                <tr>
                    <td>
                        <img className="type-img" src="images/hugeCube.jpg" alt="8x8x8"/>
                        <br/>
                    ...
                    <td>
                        <img className="type-img" src="images/2x2x3.jpg" alt="Quadun2"/>
                        <br/>
                    ...
                    <td>
                        <img className="type-img" src="images/eiForm.jpg" alt="Egg"/>
                        <br/>
                    ...
                    <td>
                        <img className="type-img" src="images/rubicsHexagon.jpg" alt="Hexa"/>
                        <br/>
